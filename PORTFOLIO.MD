...
![Tests](https://img.shields.io/badge/Tests-10%2C163_passing-brightgreen?style=flat-square)
![Lines](https://img.shields.io/badge/Source-144%2C314_lines-blue?style=flat-square)
...
Castellan flips the model. Write a declarative YAML spec. Compile it through a 5-stage pipeline. Run it against Anthropic, OpenAI, or Google. Gate every response through runtime guardrails. Audit the entire agent against the OWASP Top 10 for Agentic Applications. Export to Python, Docker, FastAPI, Kubernetes, Temporal, or Claude Code skill. Your agents are validated before they run — not after they fail.
...
```
24 commands · 219 modules · 40,433 lines · 2,691 tests, all passing
```
...
|:---|:---:|:---:|:---:|:---:|:---:|
| **Source Lines** | 8,590 | 21,409 | 73,882 | 40,433 | **144,314** |
| **Python Modules** | 53 | 83 | 313 | 219 | **668** |
| **Tests (passing)** | 538 | 2,548 | 4,386 | 2,691 | **10,163** |
| **CLI Commands** | 16 | 21 | 27 | 24 | **88** |
