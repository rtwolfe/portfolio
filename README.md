...
| **Garrison** | Hardened operator console for governed AI workloads. Single-operator Level-6 Rust shell that hosts compiled agent binaries behind a **closed allowlist** — only attested, licensed binaries load. Four deployment tiers from hosted to sovereign. |
